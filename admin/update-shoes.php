        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="tbl-30">
                ...
                <tr>
                    <td>Description:</td>
                    <td>
                        <textarea name="description" cols="30" rows="5"><?php echo $descriptiion ?></textarea>
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Shoe_name_".rand(0000, 9999).'.'.$ext;
                ...
                if($res3==true)
                {
                    $_SESSION['update'] = "<div class='success'>Shoes Uploaded Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-shoes.php');
